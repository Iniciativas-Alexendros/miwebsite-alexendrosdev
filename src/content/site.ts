export const site = {
  ...
  descriptionDefault: "Producción de sitios web (Next.js, Astro) que convierten, auditorías técnicas (Lighthouse ≥90, WCAG AA, SEO) y consultoría. Stripe/PayPal, CI verde, 0 violaciones axe-core.",
  locale: "es",
  ogLocale: "es_ES",
  nav: [
